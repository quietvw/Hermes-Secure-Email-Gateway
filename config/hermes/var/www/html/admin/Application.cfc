  ...
  <cffile action="read" file="/opt/hermes/creds/ciphermail_password" variable="CIPHERMAIL_DATASOURCE_PASSWORD">
      ...
      <cfscript>
       ...
       <cfscript>
		...
		, bundleName: 'com.mysql.jdbc'
		, bundleVersion: '5.1.40'
		, connectionString: 'jdbc:mysql://hermes_db_server:3306/Syslog?useUnicode=true&characterEncoding=UTF-8&useLegacyDatetimeCode=true&autoReconnect=true&useSSL=false&verifyServerCertificate=false&enabledTLSProtocols=TLSv1.2&requireSSL=false'
       ...
       <cfscript>
		...
		, bundleName: 'com.mysql.jdbc'
		, bundleVersion: '5.1.40'
		, connectionString: 'jdbc:mysql://hermes_db_server:3306/djigzo?useUnicode=true&characterEncoding=UTF-8&useLegacyDatetimeCode=true&autoReconnect=true&useSSL=false&verifyServerCertificate=false&enabledTLSProtocols=TLSv1.2&requireSSL=false'
...
<cfset m="Application.cfc: unable to determine a safe console host">
...
the url: https://#ConsoleHost#</cfoutput>
    --->
         ...
         <cfhttp url="https://#ConsoleHost#/user-auth/google_sso_verify.cfm?target=admin" method="GET" result="verifyResult" timeout="10" throwOnError="no">
         <cfhttpparam type="header" name="accept" value="*/*">
         <cfhttpparam type="header" name="X-Original-URL" value="https://#ConsoleHost#/admin/">
